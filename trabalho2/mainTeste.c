...
void testeListar()
{
    ...
    printf("%d\n", inserirNumeroEmEstrutura(2, 7) == SUCESSO); //1
    printf("%d\n", inserirNumeroEmEstrutura(2, -9) == SUCESSO);//1

    int vet[2];

    printf("%d\n", getDadosEstruturaAuxiliar(1, vet) == SEM_ESTRUTURA_AUXILIAR);//1
    printf("%d\n", getDadosEstruturaAuxiliar(11, vet) == POSICAO_INVALIDA);//1
    printf("%d\n", getDadosEstruturaAuxiliar(2, vet) == SUCESSO);//1

    printf("%d\n", vet[0] == 7); //1
    printf("%d\n", vet[1] == -9);//1

    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(1, vet) == SEM_ESTRUTURA_AUXILIAR); //0
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(11, vet) == POSICAO_INVALIDA); //0
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(2, vet) == SUCESSO); //0
    ...
    printf("%d\n", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO);//1
    printf("%d\n", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO);//1
}
